...
(function () {
    'use strict';
    angular.module('swoppr')
        .controller('RentProductCtrl', ['$scope', 'ProductService', RentProductCtrl]);

    function RentProductCtrl($scope, ProductService) {
        ...
        $scope.setDates = function() {
            ...
            $scope.dt2 = new Date();
            $scope.dt2.setDate($scope.dt1.getDate() +1);
            $scope.dt2.minDate = new Date();
        };
