...
Lexer.prototype = {
  ...
  bracketExpression: function(skip){
    ...
    if (start != '(' && start != '{' && start != '[') throw new Error('unrecognized snippets character');
    var end = ({'(': ')', '{': '}', '[': ']'})[start];
    var range = characterParser.parseMax(this.input, {start: skip + 1});
    if (this.input[range.end] !== end) throw new Error('snippets character ' + start + ' does not match end character ' + this.input[range.end]);
    return range;
  },
